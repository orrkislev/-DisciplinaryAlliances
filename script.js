...
colorPallets = [
    ...
    {"leftBG":"#9ceaef",   "leftTxt":"#68d8d6",   "rightBG":"#3dccc7",   "rightTxt":"#68d8d6",   "btnBack":"#c4fff9"},
    {"leftBG":"#f86624",   "leftTxt":"#f9c80e",   "rightBG":"#662e9b",   "rightTxt":"#43bccd",   "btnBack":"#ea3546"},
    {"leftBG":"#333533",   "leftTxt":"#f5cb5c",   "rightBG":"#cfdbd5",   "rightTxt":"#f5cb5c",   "btnBack":"#e8eddf"},
]

$("#txtRight").html(choose(list))
$("#txtLeft").html(choose(list))

pallet = choose(colorPallets)
